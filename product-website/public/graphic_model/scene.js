...
let fstate = getParamValue("fstate");
let cstate = getParamValue("cstate");

// FRIENDLY STATE
if (fstate=="aggressive") {
    parameters.aggressive.call();
}
else if (fstate=="f_neutral") {
    parameters.f_neutral.call();
}
else if (fstate=="friendly") {
    parameters.friendly.call();
}

// CALM STATE
if (cstate=="energetic") {
    parameters.energetic.call();
}
else if (cstate=="c_neutral") {
    parameters.c_neutral.call();
}
else if (cstate=="calm") {
    parameters.calm.call();
}
