...
function iframe() {
    return {
        ...
        __html: '<iframe id="video-game-iframe" src="/JaSMIn-master/dist/embedded-player.html?replay=http://localhost:8000/replays/data_NeQEIzs.replay" width="900px" height="500px"></iframe>'
    }
}
