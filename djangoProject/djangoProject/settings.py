...
SECRET_KEY = 'django-insecure-r0hakp+jty0)rw3(wcchju8#uvrm+cnwlx2$+yd&m)dvoi@()u'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["http://20.117.232.51"]

CORS_ALLOWED_ORIGINS = [
    "http://20.117.232.51:80"
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'commentator_website_backend' / 'templates']
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'commentator_website_backend.pagination.YourPagination',
    'PAGE_SIZE': 6,
}
